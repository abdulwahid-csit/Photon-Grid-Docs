...
To change the type of an existing chart without recreating it, call `updateChart(id, { chartType })`. See [Chart Tool Pannel](./Chart%20Tool%20Pannel.md) for updating chart settings.
